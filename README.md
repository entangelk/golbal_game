...
<img src="./docs/data/img/output.png" alt="연도별 발매수" width="100" style="display:inline-block; margin-right: 10px;" />
<img src="./docs/data/img/sales_years_total.png" alt="연도별 판매량" width="100" style="display:inline-block;" />
